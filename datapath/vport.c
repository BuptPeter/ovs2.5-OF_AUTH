...
/*
* @PeterWang 2017.03.27
* @Send a system notification,printk packet to dmesg. 
*/
void my_sent_flag(struct sk_buff *msg)
{
    printk("<0>""This is Vport speaking!\n  recevie a network packet now .\n");
    printk(msg);
}
/**
